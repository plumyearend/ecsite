        ...
        <div class="p-4 sm:p-7">
            <div class="text-center">
                ...
                <p class="mt-2 text-sm text-gray-600">
                    まだアカウントをお持ちではありませんか？
                    <a class="text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium" href="{{ route('account.signup')}}">
                        こちらからサインアップしてください
                    </a>
                </p>
            </div>
            ...
            <div class="mt-5">
                ...
                <div class="py-3 flex items-center text-xs text-gray-400 uppercase before:flex-1 before:border-t before:border-gray-200 before:me-6 after:flex-1 after:border-t after:border-gray-200 after:ms-6">または</div>
